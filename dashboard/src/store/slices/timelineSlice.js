...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${API_URL}/timeline/getall`, {
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${API_URL}/timeline/add`, data, {
      withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(`${API_URL}/timeline/delete/${id}`, {
      withCredentials: true,
    });
    dispatch(
